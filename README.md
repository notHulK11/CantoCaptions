...
| Speech                                                                                                                                                                                                                                                                                          | Example                                    |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| The sound of hesitation or "uh" (a6 / e6) is only transcribed when drawn out and not part of a longer utterance. When directly following a word in the midde of an utteracne, it should not be transcribed and an ellipsis should be used instead. | ❌你誒…係邊個啊<br>✅你…係邊個啊？<br>✅誒…你係邊個啊？<br>✅我…誒… |
