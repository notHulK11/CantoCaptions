...
| Repetition of a two-character once can either be abbreviated with a Chinese ellipsis or not depending on the speed and length of the subtitle line. The quicker the repetition and the longer the line should use an ellipsis.      | ✅ 係啊，係啊<br>✅ 係啊…             |
